...
/**
 * @class       GMEX_Easy_Payment_Html_output_MailChimp_MCAPI
 * @version	1.0.0
 * @package	easy-payment
 * @category	Class
 * @author      mbj-webdevelopment <mbjwebdevelopment@gmail.com>
 */
class GMEX_Easy_Payment_MailChimp_MCAPI {
     ...
     */
    function GMEX_Easy_Payment_MailChimp_MCAPI($apikey, $secure = false) {
        $this->secure = $secure;
