    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'HELP_ADD_FORM_WP_USER_ROLE_PICK':
                return __("Adds a new field to the form asking users to pick a role themseves. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/accounts/#htrolechoice'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_ARESP_FROM_DISP_NAME':
                return __("A name to identify the sender. It will be shown as &quot;From: MY Blog &lt;me@myblog.com&gt;&quot;. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-notifications-2/#htsendername'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_CUSTOM_PW_RESTS':
                return __("Force custom rules for password that user choose during registration. Does not appy on auto-generated passwords. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/security-settings-2/#htenablepassrules'>More</a>", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_ADMIN_NS_MSG' :
                return __("Content of the email to be sent to admin on new submission. You can use rich text and values the user submitted in the form for a more personalized message. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/email-templates/#htsubmitemailbody'>More</a>", 'custom-registration-form-builder-with-submission-manager');
