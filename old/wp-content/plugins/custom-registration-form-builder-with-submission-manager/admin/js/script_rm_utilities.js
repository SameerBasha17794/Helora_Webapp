...
function rm_get_help_text_price_field(ftype){
    ...
    switch(ftype)
    {
        case 'fixed':return "For creating fixed price single product. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htprodpricetype'>More</a>";
        case 'multisel':return "Allow user to pick multiple products with individual prices. Price will calculated as cumulative for the selection for products. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htprodpricetype'>More</a>";
        case 'dropdown':return "Allows user to pick a single product from multiple products with individual prices. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htprodpricetype'>More</a>";
        case 'userdef':return "Allows user to enter his/ her own price for product with the form. Useful for accepting donations etc. <a target='_blank' class='rm-more' href='https://registrationmagic.com/knowledgebase/add-product/#htprodpricetype'>More</a>";
