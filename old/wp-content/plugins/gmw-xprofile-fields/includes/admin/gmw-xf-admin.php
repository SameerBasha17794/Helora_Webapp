						...
						while ( bp_profile_groups () ) {
							...
							while ( bp_profile_fields () ) {
								...
								<?php if ( bp_get_the_profile_field_type() != 'datebox'  ) {  ?>	
									...
									<option value="<?php bp_the_profile_field_id(); ?>" <?php if ( isset( $gmw_options['xprofile_fields']['address_fields'][$value] ) && $gmw_options['xprofile_fields']['address_fields'][$value] == bp_get_the_profile_field_id() ) echo 'selected="selected"'; ?>>
		...
		<div id="gmw-xprofile-fields-wrapper">
			...
			<div class="gmw-multiple-xprofile-fields" <?php if ( !isset( $gmw_options['xprofile_fields']['xf_use'] ) || $gmw_options['xprofile_fields']['xf_use'] != 'multiple' ) echo 'style="display:none"'; ?>>
				...
				<?php foreach ($fieldsArray as $key => $value ) : ?>
					...
					<span class="title"><?php echo _e( ucwords($value), 'GMW-XF' ); ?>&#32;: <?php self::display_xprofile_fields( $value, $gmw_options ); ?>
