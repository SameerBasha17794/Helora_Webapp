...
<a href="<?php echo bp_displayed_user_domain() . '/profile/change-avatar/'; ?>"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Back to my profile</a>
...
<!-- <div class="user-profile-settings-menu">
	<ul>
		...
		<li><a href="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" style="font-weight: 700;">Edit Password And Email</a></li>
	</ul>
</div> -->
<!-- Custom END -->

<div class="doctor-profile-change-password">
